...
function public_full_header_html($site_type, $og_title, $og_description, $meta_title, $meta_description, $google_analytics, $fb_remarket, $snippet_details, $valid_page) {
...
function public_mobile_header_html($site_type, $og_title, $og_description, $meta_title, $meta_description, $google_analytics, $fb_remarket, $snippet_details, $valid_page) {
...
<!-- Main content divs  -->
	...
	<div class="fixed-menu" style="text-align:center; padding-bottom:5px;">
