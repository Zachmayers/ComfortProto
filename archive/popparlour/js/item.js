...
*/
		...
		$("#add_item_button").click(function() {	
			window.location = "item.php?id=new";
			return false;
		})
		...
		$("#save_new_item").click(function() {
			...
			if (item_name.length == 0) {
				...
				alert(dataString);
				$.when(send_ajax(dataString, "ajax/item.ajax.php?type=add_new_item&itemID=new")).done(function(data){
					alert(data);
