        ...
        _setupCart: function () {
            ...
            this.cart_ele.append("<div class='cart-summary-container'>\n\
                                <div class='cart-offer'></div>\n\
                                        ...
                                        <a href='#' id='empty_cart'>Empty Cart</a>\n\
                                 </div>");
        },
            ...
            $(this.options.addtoCartClass).on("click", function (e) {
                ...
                //var cost = Number($(this).attr("data-price"));
                 if ($(this).hasClass("large")) {
				        name = name + " Large";
				        if ($(this).hasClass('soy')) {
					        var cost = Number($(this).attr("data-price_large_soy"));					        
				        } else if ($(this).hasClass('almond') || $(this).hasClass('oat')) {
					        var cost = Number($(this).attr("data-price_large_other"));					        					        
				        } else {
					        var cost = Number($(this).attr("data-price_large"));					        
				        }
			    } else {
				        if ($(this).hasClass('soy')) {
					        var cost = Number($(this).attr("data-price_soy"));					        
				        } else if ($(this).hasClass('almond') || $(this).hasClass('oat')) {
					        var cost = Number($(this).attr("data-price_other"));					        					        
				        } else {
					        var cost = Number($(this).attr("data-price"));					        
				        }
			    }
			   ...
			   var buttonID = $(this).attr('ID');
			    $("#"+buttonID).hide();
			    setTimeout(function(){
				   $("#"+buttonID).fadeIn();// or fade, css display however you'd like.
				}, 1000)


                 if ($(this).hasClass("iced")) {
	              	name = "Iced " + name;   
	             }
                 ...
                 if ($(this).hasClass("almond")) {
	              	name = name + " w Almond Milk";   
	             }

                 if ($(this).hasClass("soy")) {
	              	name = name + " w Soy Milk";   
	             }

                 if ($(this).hasClass("oat")) {
	              	name = name + " w Oat Milk";   
	             }
