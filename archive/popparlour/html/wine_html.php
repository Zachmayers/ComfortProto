...
function add_wine_html($varietals) {
					...
					Enter New Wine<br />
						...
						<form class="form-horizontal">
							<div class="form-group" id="new_item_form" style="margin-bottom: 3px">
						   		<label for="item_name" class="col-md-2 col-sm-2 col-xs-10 col-xs-offset-1 col-sm-offset-2 col-sm-offset-0 control-label">Wine Name</label>
							...
							<div class="form-group">				
								<label for="new_wine_category" class="col-md-2 col-sm-2 col-xs-10 col-xs-offset-1 col-sm-offset-2 col-sm-offset-0 control-label">Category</label>
								<div class="col-md-9 col-md-offset-0 col-xs-10 col-xs-offset-1 col-sm-9  col-sm-offset-0">
									<select class='new_wine_category form-control'>
								...
								<label for="new_varietal" class="col-md-2 col-sm-2 col-xs-10 col-xs-offset-1 col-sm-offset-2 col-sm-offset-0 control-label">Varietal</label>
								<div class="col-md-9 col-md-offset-0 col-xs-10 col-xs-offset-1 col-sm-9  col-sm-offset-0">
									<select class='new_varietal form-control'>
										<option value='Cabernet Sauvignon'>Cabernet Sauvignon</option>
										<option value='Chardonnay'>Chardonnay</option>
									</select>
								</div>
								
								<label for="vintage" class="col-md-2 col-sm-2 col-xs-10 col-xs-offset-1 col-sm-offset-2 col-sm-offset-0 control-label">Vintage</label>
								<div class="col-md-9 col-md-offset-0 col-xs-10 col-xs-offset-1 col-sm-9  col-sm-offset-0">
									<input type='text' class='vintage form-control' id="description" placeholder='Vintage'><br />
								</div>
						...
						<div class="row" style="margin-bottom:25px">
							<div class="col-md-10 col-xs-10 col-md-offset-2 col-xs-offset-1">
								<button type="button" class="btn btn-success" id='save_new_wine'>
									<i class="fa fa-check-square-o" aria-hidden="true" style="background-color: transparent"></i> Add Label Next
								</button>
			
								<button type="button" class="btn btn-link" id="cancel_new_wine" style="color:#8e080b;">
									Cancel
								</button>
...
function varietal_list_html($varietal_list) {
?>
	<div class='container' style="min-height: 550px">
		<div class='row' style="margin-bottom:12px">
			<div class="col-md-12 text-center">
				<h2 style="color:black">Varietals</h2>
				<b>Select a Varietal to edit</b><br />
<?php				
				foreach($varietal_list as $row) {
					echo "<a href='wine.php?page=edit_varietal&ID=".$row['varietalID']."'>".$row['varietal']."</a><br />";
				}
?>
			</div>
		</div>
...
function varietal_details_html($varietal_details, $taste_array, $taste_options) {
	echo var_dump($varietal_details);
	echo var_dump($taste_array);
?>
		<div class='container' style="min-height: 550px">
			<div class='row' style="margin-bottom:12px">
				<div class="col-md-12 text-center">
					<h2 style="color:white"><? echo $varietal_details['varietal'] ?></h2>
					
					<b style="color:white">Profile:</b><br />
<?php
					if (count($taste_array) > 0) {
...
?>
					...
					<b style="color:white">Dry/Sweet: <? echo $varietal_details['dry'] ?></b><br />					
					<b style="color:white">Body <? echo $varietal_details['body'] ?></b><br />					
					<b style="color:white">Tannin <? echo $varietal_details['tannin'] ?></b><br />
					<b style="color:white">Acidity <? echo $varietal_details['acidity'] ?></b><br />
					<b style="color:white">Alcohol <? echo $varietal_details['alcohol'] ?></b><br />

					<hr>
					<h2 style="color:white"> Edit</h2>

							<div class="form-group">				
								<label for="dry" class="col-md-1 col-sm-2 col-xs-10 col-xs-offset-1 col-sm-offset-2 col-sm-offset-0 control-label" style="color:white">Dry/Sweet</label>
								<div class="col-md-3 col-md-offset-0 col-xs-10 col-xs-offset-1 col-sm-6  col-sm-offset-0">
									<select class='dry form-control'>
										<option value='0'>NA</option>
										<option value='1'>Bone Dry</option>
										<option value='2'>Dry</option>
										<option value='3'>Off-Dry</option>
										<option value='4'>Sweet</option>
										<option value='5'>Very Sweet</option>										
									</select>
								</div>
								
								<label for="body" class="col-md-1 col-sm-2 col-xs-10 col-xs-offset-1 col-sm-offset-2 col-sm-offset-0 control-label" style="color:white">Body</label>
								<div class="col-md-3 col-md-offset-0 col-xs-10 col-xs-offset-1 col-sm-6  col-sm-offset-0">
									<select class='body form-control'>
										<option value='0'>NA</option>
										<option value='1'>Light Body</option>
										<option value='2'>Medium Light Body</option>
										<option value='3'>Medium Body</option>
										<option value='4'>Medium Full Body</option>
										<option value='5'>Full Body</option>										
									</select>
								</div>
								
								<label for="tannin" class="col-md-1 col-sm-2 col-xs-10 col-xs-offset-1 col-sm-offset-2 col-sm-offset-0 control-label" style="color:white">Tannin</label>
								<div class="col-md-3 col-md-offset-0 col-xs-10 col-xs-offset-1 col-sm-6  col-sm-offset-0">
									<select class='tannin form-control'>
										<option value='0'>NA</option>
										<option value='1'>Low/None</option>
								...
								<label for="acidity" class="col-md-1 col-sm-2 col-xs-10 col-xs-offset-1 col-sm-offset-2 col-sm-offset-0 control-label" style="color:white">Acidity</label>
								<div class="col-md-3 col-md-offset-0 col-xs-10 col-xs-offset-1 col-sm-6  col-sm-offset-0">
									<select class='acidity form-control'>
										<option value='0'>NA</option>
								...
								<label for="alcohol" class="col-md-1 col-sm-2 col-xs-10 col-xs-offset-1 col-sm-offset-2 col-sm-offset-0 control-label" style="color:white">Alcohol</label>
								<div class="col-md-3 col-md-offset-0 col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-0">
									<select class='alcohol form-control'>
										<option value='0'>NA</option>
										<option value='1'>Under 10%</option>
										<option value='2'>10%-11.5%</option>
										<option value='3'>11.5%-13.5%</option>
										<option value='4'>13.5%-15%</option>
										<option value='5'>Over 15%</option>										
									</select>
								</div>

<?php
								foreach($taste_options as $row) {
									
?>
									<div class="form-check form-check-inline col-md-4 " style="color:white">
									  <input class="form-check-input" type="checkbox" id="inlineCheckbox<? echo $row['tasteID'] ?>" value="<? echo $row['tasteID'] ?>">
									  <label class="form-check-label" for="inlineCheckbox<? echo $row['tasteID'] ?>"><? echo $row['taste'] ?></label>
									</div>
<?php									
								}
?>	
								...
								<div class="row" style="margin-bottom:25px">
									<div class="col-md-4 col-xs-10 col-md-offset-2 col-xs-offset-1">
										<button type="button" class="btn btn-success update_varietal" id='update_varietal'>
