...
function item_owner_html($item_details, $offered_array, $wanted_array) {
	...
	<div class='container' style="min-height: 550px">
		<div class='row' style="margin-bottom:12px">
			<div class="col-md-12 text-center">
				...
				<img src="images/items/<? echo $item_details['photo'] ?>.jpg">
			</div>
		</div>
		<div class='row' style="margin-bottom:12px">
			<div class="col-md-12 text-center">
				...
				<a href="item.php?id=<? echo $item_details['itemID'] ?>&page=edit">Edit</a><br />
			</div>	
		</div>
		...
		<div class='row' style="margin-bottom:12px">
			<div class="col-md-12">
				<b>The following items are offered:</b>				
			</div>
<?php
			if(count($offered_array) > 0) {
				foreach($offered_array as $row) {
?>
				<div class="col-md-12">		
					<a href='#' class='view_item' id='<? echo $row['item_wanted'] ?>'> <? echo $row['name'] ?></a><br />
				</div>
<?php
				}				
			} else {
...
<?php
			if(count($wanted_array) > 0) {
				foreach($wanted_array as $row) {
?>
				<div class="col-md-12">
					<a href='#' class='view_item' id='<? echo $row['item_offered'] ?>'> <? echo $row['name'] ?></a><br />
				</div>
<?php
				}				
			} else {
