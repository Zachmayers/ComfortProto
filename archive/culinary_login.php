...
?>
		<h1 style="display:inline;">SBC CULINARY ADMINISTRATOR LOGIN</h1>
		<br /> &nbsp; <br />
		  ...
		  <div style="margin-bottom:15px; margin-left:110px;">
		  	<button id="culinary_login_button" class="step_button">LOGIN</button><br />
			  &nbsp; <br />
		  </div>		  
			  Forgot Password - Email Admin: admin@servebartendcook.com		  
