...
function index_html_mobile_header($size) {
	if ($size == 'large') {
		echo "<div id='fixed-menu-main' style='text-align:center; float:left;'>";
...
?>
		...
		<div id='main_page' style="float:left; width:99%; padding-left:5px; padding-right:10px; margin-top: 10px; min-height:445px ">

			<div style="text-align:center; width:98%; margin-top:30px; float:left; ">
				<h2 style="color:#4D0002;"><i>Finest Hospitality Jobs</i></h2>
				...
				<div id="fb_deactivation_warning" class="warning" style="display:none; width:100%; text-align:center;"><font color="red"><b>Your account has been deactivated.  Please contact admin@servebartendcook.com for more information. &nbsp; <br /> &nbsp; <br /></b></font></div>								
					...
					<div id="signup-buttons" style="width:100%; float:left; text-align:center;">

						<p style="margin-top: 15px; font-size: 16px;">ServeBartendCook matches open jobs with qualified hospitality workers based on their experience, skills and location.</p><br />

				    	<div style='width:85%; margin:auto; color:white;' class="btn btn-large btn-warning signup" data-page='employee'>I'm looking for a great job</div><br />
				    	<div style='width:85%; margin:auto; color:white;' class="btn btn-large btn-warning signup" data-page='employer'>I need a qualified employee</div><br />
						<div id='fb_login' style='width:84%; margin: auto; background-color:#3b5998; color:white; border-radius: 6px; padding-left:9px; padding-right:9px; padding-top:1px; padding-bottom:8px; font-size: 16px;'><img src="images/facebook_f.png" alt="facebook_button" height="24px" style="position: relative; top: 5px; right: 14px;">Sign in with Facebook</div><br />				    	
						<h5 style='margin-top:-5px; margin-bottom:-5px;'>Already on board?</h5><br />
				    	<div style='width:30%; margin:auto; color:white; background-color:#4c0100;' class="btn btn-large btn-warning login_button">Login</div><br />

				    	<div style='width:85%; margin:auto; color:#783400;' id='employer'><h4><a href='index.php?page=general_info' style='color:#783400;'>LEARN MORE</a></h2></div>
						<P style="margin-top: 0px; margin-left: 0px;" align="center">
					...
					<div id="main_loader" style="display:none; width:100%; margin-top:25px; float:left; text-align:center;"><h3>Loading....</h3> </div>
...
function index_html_mobile_employer($refID, $cmp, $rgn, $ste, $dmg, $ad, $msc_a, $msc_b) {	
?>
		<div id='employer_page' style="float:left; width:90%; padding-left:10px; padding-right:10px; margin-top: 10px; min-height:485px; display: none;">
			<span style="font-family: 'Nothing You Could Do', cursive; text-align:center; margin-bottom:15px;"><h3>Hiring for your business?</h3>
				<h4 style='margin-bottom:0px'>Sign-up & Post Jobs for Free!</h4>
			</span><br />	
...
<!-- 		        <b style='font-size:14pt'>First Name</b><br /> -->
		        <input type="text" id="firstname" placeholder="First Name" name="firstname" style='width:100%; margin-bottom:10px;'/><br />	        

<!-- 		        <B style='font-size:14pt'>Last Name</B><br /> -->
		        <input type="text" id="lastname" placeholder="Last Name" name="lastname" style='width:100%; margin-bottom:10px;' maxlength="16"/><br />     
...
<!-- 		        <B style='font-size:14pt'>Email address</B><br /> -->
		        <input type="text" id="login_email_1" placeholder="Email Address" name="login_email_1" style='width:100%; margin-bottom:10px;' maxlength="100"/><br />     
...
<!-- 		        <B style='font-size:14pt'>Password</B><br /> -->
		        <input type="password" placeholder="Choose a Password" id="set_password" name="password" style='width:100%; margin-bottom:10px;' maxlength="12" placeholder="between 6 and 12 chars"><br />	        
<!--
...
-->
				<div style='width:100%; text-align:center;'>
					<div style='display: inline-block; vertical-align: bottom; margin-right:15px; '><h3><a href='#' class='back' data-page='employer_page'>Back</a></h3></div> <div style='display: inline-block; width:50%; margin:auto; color:white; text-align:center;' class="btn btn-large btn-warning" id='employer_signup'>Get Started! -></div><br />
				</div>
				<br />

				<div style='width:100%; margin-top: 5px; float:left;'>
					<b>By clicking "Get Started", you agree to our <a href="index.php?page=TOS">TERMS OF SERVICE</a> & <a href="index.php?page=privacy_policy">PRIVACY POLICY</a></b>
				</div>			
...
function index_html_mobile_employee($refID, $cmp, $rgn, $ste, $dmg, $ad, $msc_a, $msc_b) {	
?>
		<div id='employee_page' style="float:left; width:90%; padding-left:10px; padding-right:10px; margin-top: 10px; min-height:485px; display: none;">
			<span style="font-family: 'Nothing You Could Do', cursive; text-align:center; margin-bottom:15px;"><h3>Looking for a new job?</h3>
				<h4 style='margin-bottom:0px'>Sign-up for free!</h4>
			</span>	
		  ...
		  <div id="sign_up_form" tyle="float:left; width:100%;">
		  		<div style="float:left; width:100%; margin-bottom:15px; padding-left:5px;">
		        	<label for="age">
		        		<input type="checkbox" id="age" value="18"><br /> <b>I am at least 18 years of age.</b>
		        	</label>
				</div>

<!-- 		        <b style='font-size:14pt'>First Name</b> <br /> -->
		        <input type="text" id="firstname_2" name="firstname" placeholder='First Name' style='width:100%; margin-bottom:10px;' maxlength="10"/><br />

<!-- 		        <b style='font-size:14pt'>Last Name</b> <br /> -->
		        <input type="text" id="lastname_2" name="lastname" placeholder='Last Name' style='width:100%; margin-bottom:10px;' maxlength="16"/><br />

<!-- 		        <b style='font-size:14pt'>Zip Code</b> <br /> -->
		        <input type="text" id="zip" name="zip" placeholder='Zip Code' style='width:100%; margin-bottom:10px;' /><br />
...
<!-- 		        <b style='font-size:14pt'>Email Address</b> <br /> -->
		        <input type="text" id="login_email_2" name="login_email" placeholder='Email Address' style='width:100%; margin-bottom:10px;' maxlength="100"/><br />
...
<!-- 		        <b style='font-size:14pt'>Password</b> <br /> -->
		        <input type="password" id="set_password_2" name="password" placeholder='Select a Password' style='width:100%; margin-bottom:10px;' maxlength="12" placeholder="between 6 and 12 chars"><br />
...
-->
				...
				<div style='width:100%; text-align:center;'>
					<div style='display: inline-block; vertical-align: bottom; margin-right:15px; '><h3><a href='#' class='back' data-page='employee_page'>Back</a></h3></div> <div style='display: inline-block; width:50%; margin:auto; color:white; text-align:center;' class="btn btn-large btn-warning" id='employee_signup'>Get Started! -></div><br />
				</div>
							<br />
...
function index_fb_signup_html_mobile() {
?>
	<div id='employee_page' style="float:left; width:90%; padding-left:10px; padding-right:10px; margin-top: 10px; min-height:485px;">

		<h3 style="text-align:center">Sign-Up with Facebook</h2>
		 ...
		 <div id='fb_duplicate_warning' class='warning' style='width:100%; text-align:center; padding-bottom:10px; display:none'>
		  ...
		  <div id='fb_signup_holder' class='fb_signup_holder'>
		        <input type="text" id="firstname" placeholder="First Name" name="firstname" value='<? echo $_SESSION['fb_firstname'] ?>' style='width:100%; margin-bottom:10px;'/><br />	        
		        <input type="text" id="lastname" placeholder="Last Name" name="lastname" value='<? echo $_SESSION['fb_lastname'] ?>' style='width:100%; margin-bottom:10px;'/><br />	        
		        <input type="text" id="zip" placeholder="Zip Code" name="zip" style='width:100%; margin-bottom:10px;'/><br />	        
		        <input type="text" id="email" placeholder="Email Address" name="email" value='<? echo $_SESSION['fb_email'] ?>' style='width:100%; margin-bottom:10px;'/><br />	        
				<input type='hidden' id='fb_ID' value='<? echo $_SESSION['fb_ID'] ?>'> 
		  
		  <div style="margin-bottom:15px; width:100%; text-align:center; padding-top:15px;" class='fb_signup_holder'>

				<div style='display: inline-block; width:80%; margin:auto; color:white; text-align:center;' class="fb_signup btn btn-large btn-warning" id="employee">Continue as Job Seeker</div><br />
			  &nbsp; <br />
				<div style='display: inline-block; width:80%; margin:auto; color:white; text-align:center;' class="fb_signup btn btn-large btn-warning" id="employer">Continue as Employer</div><br />
		 </div>
...
function index_fb_connect_html_mobile() {
?>
	<div style="float:left; width:90%; padding-left:10px; padding-right:10px; margin-top: 10px; min-height:485px;">
			<h3 style="text-align:center; margin-bottom:0px; ">Connect Facebook Account</h3>
				<div id='email_form'>
				<i>Connecting your Facebook account will allow one-click login.</i><br />
				&nbsp; <br />
				  ...
				  <input type="text" id="connect_email" placeholder="Email Address" name="email" style='width:100%; margin-bottom:10px;'/><br />	        
				  <input type="password" id="connect_pass" placeholder="Password" name="password" style='width:100%; margin-bottom:10px;'/><br />	        
				   <input type='hidden' id='fb_ID' value='<? echo $_SESSION['fb_ID'] ?>'>
					 
					 <div style="margin-bottom:15px; margin-top:25px; width:100%; text-align:center;">
					 	<div style='display: inline-block; width:80%; margin:auto; color:white; text-align:center;' class="btn btn-large btn-warning" id="fb_connect">Connect Facebook Account</div><br />
					 </div>			    
				</div>
				...
				<div id='final_text' style='display:none'>
					...
					<b>You will now be able to log in to the site with one click. </b><br />
						...
						<div id='fb_login' style='width:84%; margin: auto; background-color:#3b5998; color:white; border-radius: 6px; padding-left:9px; padding-right:9px; padding-top:2px; padding-bottom:8px; font-size: 16px; text-align:center;' ><img src="images/facebook_f.png" alt="facebook_button" height="24px" style="position: relative; top: 5px; right: 10px;">Sign in with Facebook</div><br />	
				</div>
		</div>
	</div>
<?php
...
function index_html_mobile_complete($userID, $email) {
	echo "<div id='complete_page' style='width:100%; float:left; margin-left:3px; margin-right:3px; margin-top:10px; min-height:450px; text-align:center'>";

	if ($userID == "NA") {
		echo "<h2>Oops, there's nothing here</h2>";
		echo "Home <br />";		
	} else {
			echo "<h3>Sign-Up Complete!</h3>";
			echo "&nbsp; <br />";
			echo "An email verification link has been sent to:<br /><h4>".$email."</h4>";
			echo "<i>Please make sure your email address is correct.</i><br />";
			echo "<b><a href='#' id='wrong_email'>CHANGE EMAIL ADDRESS</a></b><br />";

			echo "&nbsp; <br />";
			echo "&nbsp; <br />";
			
			echo	"<div style='display: inline-block; width:50%; margin:auto; color:white; text-align:center;' class='btn btn-large btn-warning login_now' id='".$_SESSION['type']."'>Login Now</div><br />";
			echo "&nbsp; <br />";	

			if ($_SESSION['type'] == "employer") {							
				//echo "<span id='reminder_holder'><b><a href='#' id='send_reminder'>Remind me to login later</a></b></span>";
			...
			echo "<div style='float:left; width:99%; margin-left:3px; margin-right:7px;'>";
			if ($_SESSION['type'] == "employer") {		
				echo "<i>Note: You'll need to click the verification link sent to your email before you can post a job.</i><br />";
			} elseif ($_SESSION['type'] == "employee") {
				echo "<i>Note: You'll need to click the verification link sent to your email before you can apply for a job.</i><br />";				
			}
			echo "</div>";
		...
		echo "<div id='email_change_holder' style='display:none;width:100%; float:left; margin-left:3px; margin-right:3px; margin-top:10px; text-align:center; min-height:450px;'>";
		    ...
		    echo "<input type='text' placeholder='Email Address' id='new_email' name='new_email' style='width:90%; margin-top:0px; margin-bottom:10px;'><br />";	        
			...
			echo "&nbsp; <br />";
			echo "<a href='#' id='wrong_email_back'>GO BACK</a>";
		echo "</div>";
			
	}
}

function index_html_general_info_mobile($email, $refID, $cmp, $rgn, $ste, $dmg, $ad, $msc_a, $msc_b) {	
	$url_tags = "refID=".$refID."&CMP=".$cmp."&RGN=".$rgn."&STE=".$ste."&DMG=".$dmg."&AD=".$ad."&MSCA=".$msc_a."&MSCB=".$msc_b;						
?>
			<div class="page" style="margin-left:15px; margin-right:15px; ">
					<p>&nbsp;</P>				
					<span style="font-family: 'Nothing You Could Do', cursive; text-align:center;"><h2>How it works...</h2></span>	

				
						   <div class="bubble">
							<h2 style="margin-top:0px;">We Make it Easy</h2>
								Create a user profile as an employer or an employee. Tell us who you are, and what you want.<br />
								It's free to find jobs and to post jobs.
							</div>

							<div class="bubble">
							<h2 style="margin-top:0px">The Right Job For The Right Person</h2>
									We match posted jobs with the best available people, based on specific skills and experience. 
							</div>
							
							<div class="bubble">
							<h2 style="margin-top:0px">Fast And Effective</h2>
								Instantly receive an email when a match is made. Set up an interview. Fill any position from the convenience of your phone.	
							</div>
							
						   <div class="bubble">
							<h2 style="margin-top:0px;">And it is free!</h2>
								It is free to create a profile and get matched to jobs AND it is free for employers to post jobs on the site!<br />
							</div>							
							
							<div style='width:100%; float:left; margin-left:40px;'>
								<a href='index.php?<? echo $url_tags ?>'><img src="images/button-signup.png"></a>
							</div>
				
						<p style="margin-top: 40px; margin-left: 30px;">If you have questions or comments, email us at:  <b>admin@servebartendcook.com</b></p>					
			</div>
<?php
}
...
?>
		<div id="login_page" class="page" style="display:none; float:left; font-size:14pt; text-align:center; margin-top:10px; width:99%; min-height: 425px;">
			<h1>Login</h1>
			<div id="invalid_login" class='warning' style="display:none">
				<font color="red">Invalid Login or Password</font>
			</div>		
			<div id="deactivation_warning" class='warning' style="display:none">
		  ...
		  <input type='hidden' id='type' value='<? echo $device ?>'>		  
		    ...
		    <div id='login_holder' style='text-align:center'>
			    <a href='#' class='login_cancel'>Go Back</a> &nbsp; &nbsp; 
		    	<a href="#" class="btn btn-large btn-primary" id='login-submit'>Login</a><br />
		    	&nbsp; <br />
		    	<a href="index.php?page=help">Forgot Password</a> 
		    </div>
		    
		    <div id='login_loader' style='display:none; width:100%; float:left; text-align:center;'>
				<h3>Loading....</h3>
		    </div>
...
?>
		<div id="login_page" class="page" style="font-size:14pt; text-align:center; min-height: 565px;">
		    	&nbsp; <br />
		    <h3>Welcome Back!</h3>
		    	&nbsp; <br />
			  ...
			  <div id="mobile_pass_form">
			    ...
			    <div id="verification_warning" style="display:none">
				  ...
				  <div id='forgot_pass_holder'>
				 	 <a href="#" class="btn btn-large btn-primary" id='password_reset_button'>Submit</a> <a href="#" class="btn btn-large btn-primary help_back" id='help_back'>Back</a><br />			  
				  </div>
			  ...
			  <div id="verification_form">
				...
				<div id="error" style="display:none">
				  ...
				  <div id='verification_holder'>			  		
				  	<a href="#" class="btn btn-large btn-primary" id='verification_button'>Submit</a> 	<a href="#" class="btn btn-large btn-primary help_back" id='help_back'>Back</a><br />			  
				  </div>
...
function mobile_footer_html() {
?>
		<div id='red-footer' class='main_footer' style='float:left; width:100%;'>
				<span style='color:white; margin-top:10px; float:left; width:100%;'>Copyright &copy; 2015 SBC Industries, LLC</span><br /> 
...
function index_tests_html() {
?>
	<div style="width:100%; float:left; background-color:#8e080b; min-height:850px;">
			<img src='images/FullWebsiteHeader.png' width='98%;' style='padding-top:15px;'><br />

		<div style='margin-top:100px; text-align:center;'>
		<h1 style='color:white'>I would like to...</h2>
			
		<div style='width:200px; float:left; padding-top:7px; padding-bottom:7px; border-radius:5px; border-style:solid; border-width:2px; border-color:white; text-align:center; color:white'>
			Find a Great Job
		</div>

		<div style='width:200px; float:left; padding-top:7px; padding-bottom:7px; border-radius:5px; border-style:solid; border-width:2px; border-color:white; text-align:center; color:white'>
			Make Money Referring a Colleague
		</div>
