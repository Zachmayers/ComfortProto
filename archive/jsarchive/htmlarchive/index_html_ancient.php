...
?>
	...
	<header>
		...
		<div class="container">
			...
			<nav>
				<ul>
					<li><a href="http://servebartendcook.com/blog">Blog</a></li>
				</ul>																																			
				<ul>
...
?>
			...
			<div class="price centered"> <!-- Alignments options: right_align, left_align, centered -->
				<p>Sign up today for Free!</p>	
						<P style="margin-top: 40px; margin-left: 0px;" align="center"><a href="http://facebook.com/servebartendcook"><img src="images/facebook.png" border="0"></a> <a href="http://twitter.com/servebarcook"><img src="images/twitter.png" border="0"></a></P>
			</div>
...
-->
		      <tr><td colspan="2" align="center" style="font-size: 11px; padding: 10px">By clicking "Submit", you agree to the following:</br>  <b><a href="index.php?page=TOS">Terms of Service</a>, <a href="index.php?page=privacy_policy"> Privacy Policy</a></b></td></tr>
		    </table>
		  </div>
		  <div style="margin-bottom:15px; margin-left:150px;"><button id="employee_signup" class="step_button">SUBMIT</button></div>		  
...
function index_html_complete($userID, $email) {
	...
	if ($userID == "NA") {
		...
		echo "Home <br />";		
			...
			echo "&nbsp; <br />";
			echo "<b>An email verification link has been sent to:<br />".$email."</b><br />";
			echo "<i>Please make sure you email address is correct.</i><br />";
			echo "<b><a href='#' id='wrong_email'>CHANGE EMAIL ADDRESS</a></b><br />";

			echo "&nbsp; <br />";
			echo "&nbsp; <br />";
			
			echo	"<div style='display: inline-block; width:50%; margin:auto; color:white; text-align:center;' class='btn btn-large btn-warning' class='login_now' id='">$_SESSION['type']."'>Login Now</div><br />";
			echo "&nbsp; <br />";	
			if ($_SESSION['type'] == "employer") {							
				echo "<span id='reminder_holder'><b><a href='#' id='send_reminder'>Send me a reminder later</a></b></span>";
			...
			echo "<div style='float:left; width:99%; margin-left:3px;'>";
			if ($_SESSION['type'] == "employer") {		
				...
				echo "<i>Note: You'll need to click verification link sent to your email before you can apply to a job.</i><br />";				
			}
			echo "</div>";
	...
	<!-- Start Footer -->
		...
		<footer style='background-color: #8e080b'>	
			<div style='background-color: #8e080b; min-height:75px;'>		
				<p><a href="http://servebartendcook.com/index.php?page=privacy_policy">Privacy Policy</a> | Copyright &copy; 2015 SBC Industries, LLC | <a href="http://servebartendcook.com/index.php?page=TOS">Terms of Use</a></p><br />		
